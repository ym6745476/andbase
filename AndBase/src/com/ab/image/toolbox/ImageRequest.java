...
public class ImageRequest extends Request<Bitmap> {
    ...
    public ImageRequest(String url, Response.Listener<Bitmap> listener, int maxWidth, int maxHeight,
            Config decodeConfig, Response.ErrorListener errorListener,int expiresTime) {
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (mMaxWidth == 0 && mMaxHeight == 0) {
            ...
            if (tempBitmap != null && (tempBitmap.getWidth() > desiredWidth ||
            	...
            	//修改处理方式，解决OOM
            	bitmap = AbImageUtil.getScaleBitmap(tempBitmap, desiredWidth, desiredHeight);
                //tempBitmap在AbImageUtil处理了回收
            } else {
                bitmap = tempBitmap;
            }
        }
        ...
        if (bitmap == null) {
            ...
            return Response.success(bitmap, HttpHeaderParser.parseCacheHeaders(response,mExpiresTime));
        }
    }
